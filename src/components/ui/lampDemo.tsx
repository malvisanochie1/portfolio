...
export const LampContainer = ({ children, className }: LampContainerProps) => {
  ...
  // Measure the height of the child content
  useEffect(() => {
  ...
  // Calculate the total container height (content + reduced lamp effect space)
  const containerHeight = contentHeight + 200; // Reduced from 400 to 200
