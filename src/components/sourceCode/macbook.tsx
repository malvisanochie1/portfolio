...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex md:min-h-screen shrink-0 scale-[0.35] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-100 ">
      <motion.h2
        style={{
  ...
  return (
    <div
      ...
      <div className="mb-[2px] flex w-full shrink-0 gap-[2px]">
        ...
        <KBtn className="" childrenClassName="">
      ...
      <div className="mb-[2px] flex w-full shrink-0 gap-[2px]">
        ...
        <KBtn className="w-[8.2rem]" childrenClassName="">space</KBtn>
        <KBtn className="w-8" childrenClassName="h-full justify-between py-[4px]">
          <div className="flex w-full justify-start pl-1">
            <IconCommand className="h-[6px] w-[6px]" />
          </div>
        ...
        <div
          ...
          <KBtn className="h-3 w-6" childrenClassName="">
